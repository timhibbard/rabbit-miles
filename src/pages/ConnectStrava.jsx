...
function ConnectStrava() {
  ...
  const features = [
    { icon: "📊", title: "Personal totals", description: "Last week, month, year" },
    { icon: "⏱️", title: "Time on trail", description: "Elapsed time, moving time toggle" },
    { icon: "📈", title: "Projections", description: "On pace for this week, month, year" },
    { icon: "🏆", title: "Opt-in leaderboards", description: "Only shared if you join" },
    { icon: "🔒", title: "Data control", description: "Revoke access and delete your data anytime" }
  ];
        ...
        <div className="text-center">
          ...
          <div className="space-y-3 text-sm text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="pt-4 flex items-center justify-center gap-2 text-xs text-gray-400">
              ...
              <svg className="w-16 h-4" fill="currentColor" viewBox="0 0 432 100">
